# Analyse FrontEnd Page Accueil 18
...
### Déroulement:
Sur le poste client, depuis la page internet de son navigateur (le Front), n'importe quel utilisateur doit pouvoir arriver sur la page d'accueil du site. 
...
### C - S - R:  
Pour cet Epic, nous passons par Thymeleaf, le moteur de template - interface.
